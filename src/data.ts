...
function seedAbsences(): AbsenceRequest[] {
  ...
  return [
    ...
    },
    {
      ...
      attachments: ["certificado-medico.pdf"],
      status: "Aprobado",
...
export function seedState(): AppState {
  ...
  return {
    ...
    integrations: [
      { id: "i1", name: "Google Calendar", desc: "Sincronizá tus registros y ausencias con tu calendario.", icon: "📅", connected: true },
      { id: "i2", name: "Outlook Calendar", desc: "Eventos y reuniones desde Microsoft 365.", icon: "📆", connected: false },
      { id: "i3", name: "Microsoft Teams", desc: "Estado y recordatorios en Teams.", icon: "💬", connected: false },
      { id: "i4", name: "Slack", desc: "Notificaciones y comandos /tempo.", icon: "🔔", connected: true },
      { id: "i5", name: "Jira", desc: "Importá issues como tareas.", icon: "🧩", connected: false },
      { id: "i6", name: "Trello", desc: "Tarjetas como tareas de proyecto.", icon: "🗂️", connected: false },
      { id: "i7", name: "Asana", desc: "Tareas y proyectos sincronizados.", icon: "✅", connected: false },
      { id: "i8", name: "ClickUp", desc: "Sincronización bidireccional de tareas.", icon: "⚡", connected: false },
      { id: "i9", name: "Notion", desc: "Bases de datos de proyectos.", icon: "📓", connected: false },
      { id: "i10", name: "GitHub", desc: "Vinculá commits y PRs a registros.", icon: "🐙", connected: false },
      { id: "i11", name: "Autodesk Construction Cloud", desc: "Proyectos ACC como proyectos de Tempo.", icon: "🏗️", connected: true },
      { id: "i12", name: "API REST", desc: "Tokens de acceso y documentación de la API.", icon: "🔌", connected: true },
      { id: "i13", name: "Webhooks", desc: "Eventos en tiempo real hacia tus sistemas.", icon: "🪝", connected: false },
    ],
  };
}
